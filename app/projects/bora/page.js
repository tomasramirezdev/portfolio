...
const designProcess = [
  {
    ...
    description:
      "Viví en Ilha Grande y experimenté de primera mano el caos de comprar paseos: vendedores en la playa, precios sin claridad, sin disponibilidad online, sin posibilidad de reservar con antelación. Eso fue el brief.",
  },
  {
    number: "02",
    title: "Estrategia de marca & naming",
    description:
      "'Bora' — una expresión brasileña que significa 'vamos'. Energética, simple, perfecta para una plataforma de turismo de aventura. Definí el posicionamiento, el tono de voz y los valores de la marca antes de dibujar ni un pixel.",
  },
  {
    number: "03",
    title: "Branding completo — logo e identidad visual",
    description:
      "Diseñé el logo desde cero: símbolo, tipografía y sistema de color inspirado en el agua turquesa y la selva de Ilha Grande. Construí el brandbook completo con reglas de uso, paleta, tipografía y aplicaciones.",
  },
  {
    number: "04",
    title: "UX/UI Design en Figma",
    description:
      "Wireframes, flujos de reserva, sistema de componentes y diseño de alta fidelidad para web y mobile. El foco estuvo en simplificar el proceso de booking: buscar paseo → ver disponibilidad → reservar y pagar en menos de 3 pasos.",
  },
  {
    number: "05",
    title: "Desarrollo front-end",
    description:
      "Implementé el diseño en HTML5, CSS3 y JavaScript vanilla. Calendario de disponibilidad en tiempo real, filtros por tipo de actividad, cards de prestadores con galería de fotos y formulario de pago integrado.",
  },
  {
    number: "06",
    title: "Testing & optimización",
    description:
      "Validé en múltiples dispositivos — muchos turistas acceden desde el celular con mala señal. Optimicé el peso de las imágenes y el tiempo de carga para funcionar bien incluso con 3G.",
  },
];
...
const challenges = [
  {
    ...
    description:
      "Ilha Grande tiene decenas de operadores de paseos, cada uno con su propio sistema (o ninguno). Integrar toda esa oferta en una experiencia coherente sin que parezca un bazar fue el mayor desafío de arquitectura.",
    solution:
      "Diseñé un sistema modular donde cada prestador tiene su perfil propio pero dentro de una interfaz unificada. El usuario siempre siente que navega en BORA, no en el sitio de cada operador. La plataforma aumentó las reservas online un 60% en testing con usuarios reales.",
  },
  {
    number: "02",
    challenge: "Diseñar para turistas internacionales con señal limitada",
    description:
      "El usuario llega a Ilha Grande de vacaciones, con el celular con poca batería, señal de 3G en el mejor caso, y quiere reservar rápido. Cualquier fricción lo manda de vuelta al vendedor en la playa.",
    solution:
      "Reduje el flujo de reserva a 3 pasos con pantallas limpias y sin distracciones. Optimicé las imágenes con lazy loading, minimicé el JavaScript y prioricé la carga del formulario de reserva. El tiempo de carga bajó un 55%.",
  },
  {
    number: "03",
    challenge: "Crear una marca desde cero que capture la esencia del lugar",
    description:
      "No había brand previo, ni guidelines, ni referencia. Tenía que crear algo que evocara Ilha Grande — el agua, la selva, la aventura — sin caer en clichés turísticos baratos.",
    solution:
      "El verde-turquesa del agua de Ilha Grande como color principal, tipografía sans-serif moderna con carácter, y un logo que combina movimiento y naturaleza. La identidad quedó tan sólida que funcionó tanto en digital como impresa en remeras y carteles.",
  },
];
    ...
    <>
      ...
      >
        ...
        <section className="relative flex min-h-[100dvh] flex-col items-center justify-center overflow-hidden px-4 pb-20 pt-28 text-center">
          ...
          {/* Diagonal stripes — evoca velocidad y movimiento tropical */}
          <div
            aria-hidden="true"
          ...
          >
            ...
            <motion.p
              ...
              style={{ color: C.teal }}
            >
              Proyecto 03 &nbsp;·&nbsp; Proyecto personal &nbsp;·&nbsp; Ilha Grande, Brasil
            </motion.p>
            ...
            <motion.div variants={fadeUp} className="mb-6 flex justify-center">
              ...
              >
                ...
                />
                Branding · UX/UI · Desarrollo completo
              </span>
            </motion.div>
            ...
            >
              Plataforma de booking de paseos y excursiones para Ilha Grande. Un proyecto personal nacido de vivir en la isla y ver de cerca el caos que era comprar un paseo.
            </motion.p>
        ...
        <section className="px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
          <div className="mx-auto max-w-5xl grid gap-12 lg:grid-cols-12 lg:gap-16">
            ...
            >
              ...
              >
                Cuando vivís el problema, diseñás la solución correcta.
              </h2>
              <p className="mt-5 text-base leading-relaxed sm:text-lg" style={{ color: "rgba(241,240,255,0.52)" }}>
                Viví en Ilha Grande — una isla paradisíaca en Brasil, sin autos y con conexión limitada. Comprar un paseo significaba caminar por la playa buscando vendedores, negociar precios sin claridad y esperar que hubiera lugar. Un caos total.
              </p>
              <p className="mt-4 text-base leading-relaxed sm:text-lg" style={{ color: "rgba(241,240,255,0.52)" }}>
                BORA nació de esa experiencia. Creé todo desde cero:{" "}
                <strong style={{ color: "#f1f0ff" }}>el nombre, el logo, la identidad visual, el UX/UI y el desarrollo front-end completo</strong>.
                Una plataforma donde turistas pueden descubrir, comparar y reservar paseos en minutos — desde cualquier dispositivo, con cualquier señal.
              </p>

              {/* Highlight strip — contexto personal */}
              <div
              ...
              >
                ...
                <p className="text-sm leading-relaxed" style={{ color: "rgba(241,240,255,0.7)" }}>
                  &ldquo;La mejor investigación de usuarios es vivir el problema. No hubo entrevistas ni encuestas — hubo semanas caminando la playa, frustrado, sin poder reservar un paseo en lancha.&rdquo;
                </p>
              </div>
            </motion.div>
          ...
          <div className="mx-auto max-w-5xl">
            ...
            >
              ...
              <p className="mt-1 text-sm" style={{ color: "rgba(241,240,255,0.35)" }}>
                Branding, pantallas UI y experiencia final
              </p>
            </motion.div>
          ...
          <div className="mx-auto max-w-5xl">
            ...
            >
              ...
              <h2
                ...
                style={{ fontSize: "clamp(1.75rem,4vw,2.25rem)", color: "#f1f0ff" }}
              >
                Isla paradisíaca, problemas reales.
              </h2>
            </motion.div>
        ...
        >
          © {new Date().getFullYear()} Tomas Ramirez &nbsp;·&nbsp; BORA — Proyecto personal · Ilha Grande, Brasil
        </footer>
      </div>
    </>
  );
